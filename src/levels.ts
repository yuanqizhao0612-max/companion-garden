...
export const LEVELS: LevelConfig[] = [
  ...
  level(4, '石径初现', '观察花朵分布，规划一到两步', 27, { daisy: 23, leaf: 18 }, [14, 15], [], '先从棋盘中央寻找连续机会'),
  level(5, '花间小路', '组合四连，让花朵连成小路', 28, { peach: 25, bell: 21 }, [8, 14, 20, 26], [], '四连会留下带柔光标记的特别花'),
  level(6, '双树之间', '兼顾目标花与连续消除顺序', 29, { berry: 27, daisy: 23 }, [13, 16, 19, 22], [8, 27], '先收集数量较多的目标花'),
  ...
  level(9, '门前花径', '在花海中寻找关键移动', 32, { daisy: 40, bell: 30 }, [8, 9, 14, 15, 20, 21], [], '先从中央寻找可以延伸的花'),
